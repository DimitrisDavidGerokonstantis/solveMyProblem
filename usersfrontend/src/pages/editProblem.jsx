...
const EditProblem = () => {
    ...
    <React.Fragment>
        ...
        <div class="w-full p-9 mt-10 bg-red-100 rounded-lg shadow-lg mb-10">
                    <h1 class="text-center text-xl sm:text-xl font-semibold mb-4 text-gray-800">Selected model</h1>
                    <h1 class="text-center text-xl sm:text-xl font-semibold mb-4 text-gray-800">{model}</h1>
                    </div>
