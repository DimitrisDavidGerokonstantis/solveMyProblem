  ...
  <div class="h-screen w-3/5 bg-orange-900">
    <div class="mx-auto flex h-screen w-2/3 flex-col justify-center text-white xl:w-1/3">
      ...
      <div class="mt-10">
        ...
        <p class="text-sm mt-3">You already have an account ? <Link class="text-blue-400 underline" to="/login">Login</Link></p>
          <div class="my-10">
            <button class="w-full rounded-full bg-orange-700 p-5 hover:bg-orange-600">Register</button>
          </div>
        </form>
      </div>
      <div>
