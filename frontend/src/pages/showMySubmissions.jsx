  ...
  return (
    <div className="money">
      ...
      <div className="flex justify-between">
        <h2 className="text-2xl font-bold text-blue-500 flex-initial">
          My Submissions
        </h2>
        <button
          onClick={() => navigate("/submitproblem")}
          className="bg-green-500 text-white rounded-md px-4 py-2 hover:bg-green-700 transition flex-initial"
        >
          Submit new problem
        </button>
      </div>
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                <p class="text-sm text-gray-500">
                  ...
                  <span class="font-bold">Sample Item</span>? This action cannot
                  be undone.{" "}
                </p>
              </div>
            </div>
