    ...
    if (!error) {
      ...
      try {
        ...
        const res = await axios.post(
          `http://localhost:8080/api/submitProblem/submit`,
          {
            userID: 1,
            pythonScript: {
      ...
      <div class=" bg-orange-50 bg-cover w-screen h-screen flex-col items-center justify-center overflow-scroll">
        <div class="flex flex-col justify-center items-center relative">
          ...
          <button
            ...
            id="dropdown-button"
            class="mb-2 mt-10 w-fit inline-flex justify-center px-4 py-2 text-sm font-medium text-orange-900 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-yellow-900"
          >
            ...
            {models.map((model, index) => {
              return (
                <a
                  ...
                  href="#"
                  class="w-max block px-4 py-2 text-gray-700 hover:bg-gray-100 active:bg-blue-100 cursor-pointer rounded-md"
                >
                  {model}
                </a>
              );
              ...
              <div className="relative w-auto my-6 mx-auto max-w-3xl">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  <div className="mt-60 flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                    <h3 className="text-3xl font-semibold">Input data file</h3>
                    <button
